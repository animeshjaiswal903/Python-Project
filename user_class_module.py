class import_class:
    ...
    def import_price(self):
        ...
        #defining new variable cart items and` it will be used further.
        self.cart_items={}  
...
class choice_class:
    ...
    def category_select(self):
        ...
        #z1 execution # z1 is used to get product_names and this product_names list is used further in z3 dict.
        while(True):
